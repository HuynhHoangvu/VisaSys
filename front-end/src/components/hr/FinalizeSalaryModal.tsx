  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="p-4 sm:p-5 border-b border-slate-200 bg-red-50">
        ...
        <div className="p-4 sm:p-5">
          ...
          <input
            ...
            placeholder="MM/YYYY"
            className="w-full p-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all font-bold text-center text-base sm:text-lg tracking-widest"
          />
        </div>
        <div className="p-4 border-t border-slate-200 flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 bg-slate-50">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-4 py-2 text-slate-700 bg-white border border-slate-300 rounded-lg hover:bg-slate-50 font-medium text-sm sm:text-base"
