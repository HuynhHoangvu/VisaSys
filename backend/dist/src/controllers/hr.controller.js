...
export const addManualBonus = async (req, res) => {
    try {
...
// ==========================================
export const finalizeMonthSalary = async (req, res) => {
    try {
        ...
        await prisma.$transaction(async (tx) => {
            ...
            for (const emp of employees) {
                ...
                const attendanceFines = emp.attendanceRecords.reduce((sum, r) => sum + (r.fine || 0), 0);
